  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Mukesh Dani</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/mukeshdani" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://in.linkedin.com/in/mukeshdani00" target="_blank">
          <ImLinkedin />
        </a>
        <a
          href="https://www.instagram.com/mukeshdani00" target="_blank">
          <AiOutlineInstagram />
        </a>
      ...
      <div className="imgcontainer1 absolute violet-gradient">
        <img src={mukesh} alt="" className="object-contain"/>
      </div>
      </div>

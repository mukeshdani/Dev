...
import "./Contact.scss";
import {templete_id , gamil_sercide_id , public_key, to_name, to_email} from "../../Ignore_files/secretFile";
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:mukeshdani00@gmail.com" target="_blank" className="blue-text-gradient">mukeshdani00@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=918755380297&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +91 8755380297
            </a>
          </article>
        </div>

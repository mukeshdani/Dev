  ...
  const experiences = [
    {
      ...
      points: [
        "Talent Acquisition Dashboard & Data Lake Development",
        "Dashboard and Data Lake Development: Developed a comprehensive dashboard and centralized data lake, integrating data from Oracle Fusion, HRMS, and Tydy using API, SQL. Achieved 97% data accuracy, facilitating informed decision-making and improving reporting efficiency by 90%.",
        "Data Security Measures: Implemented robust data security measures with an admin portal for access control. Utilized technologies like React, Django, Docker to ensure high performance and scalability, enhancing data security by 97%.",

        "IT Infrastructure Management",
        "IAM Roles Management: Managed IAM roles and optimized ESXI licenses, resulting in 30% cost savings and improved resource utilization.",
        "Infrastructure as Code (IaC): Designed and implemented IaC solutions using Terraform, ensuring consistent environment provisioning and compliance with security standards, reducing deployment times by 30%.",
      ],
      link: "https://www.adani.com/",
    },
    {

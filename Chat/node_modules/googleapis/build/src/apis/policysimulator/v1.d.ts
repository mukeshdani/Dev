...
export declare namespace policysimulator_v1 {
    ...
    export class Resource$Organizations$Locations$Orgpolicyviolationspreviews {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreview>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPolicysimulatorV1ListOrgPolicyViolationsPreviewsResponse>;
    ...
    export class Resource$Organizations$Locations$Orgpolicyviolationspreviews$Orgpolicyviolations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Orgpolicyviolations$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Orgpolicyviolations$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse>;

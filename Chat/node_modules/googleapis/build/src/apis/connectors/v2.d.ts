...
export declare namespace connectors_v2 {
    ...
    export class Resource$Projects$Locations$Connections$Entitytypes$Entitieswithacls {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Connections$Entitytypes$Entitieswithacls$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
        list(params?: Params$Resource$Projects$Locations$Connections$Entitytypes$Entitieswithacls$List, options?: MethodOptions): GaxiosPromise<Schema$ListEntitiesWithACLsResponse>;
        list(params: Params$Resource$Projects$Locations$Connections$Entitytypes$Entitieswithacls$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Connections$Entitytypes$Entitieswithacls$List, options: MethodOptions | BodyResponseCallback<Schema$ListEntitiesWithACLsResponse>, callback: BodyResponseCallback<Schema$ListEntitiesWithACLsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Connections$Entitytypes$Entitieswithacls$List, callback: BodyResponseCallback<Schema$ListEntitiesWithACLsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListEntitiesWithACLsResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Connections$Entitytypes$Entitieswithacls$List extends StandardParameters {
        /**
         * Conditions to be used when listing entities. From a proto standpoint, There are no restrictions on what can be passed using this field. The connector documentation should have information about what format of filters/conditions are supported.
         */
        conditions?: string;

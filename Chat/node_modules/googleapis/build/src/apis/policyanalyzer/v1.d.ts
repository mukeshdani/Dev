...
export declare namespace policyanalyzer_v1 {
    ...
    export class Resource$Folders$Locations$Activitytypes$Activities {
        ...
        query(params?: Params$Resource$Folders$Locations$Activitytypes$Activities$Query, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPolicyanalyzerV1QueryActivityResponse>;
    ...
    export class Resource$Organizations$Locations$Activitytypes$Activities {
        ...
        query(params?: Params$Resource$Organizations$Locations$Activitytypes$Activities$Query, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPolicyanalyzerV1QueryActivityResponse>;

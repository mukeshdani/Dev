...
export declare namespace policyanalyzer_v1beta1 {
    ...
    export class Resource$Folders$Locations$Activitytypes$Activities {
         ...
         */
        query(params: Params$Resource$Folders$Locations$Activitytypes$Activities$Query, options: StreamMethodOptions): GaxiosPromise<Readable>;
        query(params?: Params$Resource$Folders$Locations$Activitytypes$Activities$Query, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse>;
    ...
    export class Resource$Organizations$Locations$Activitytypes$Activities {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        query(params: Params$Resource$Organizations$Locations$Activitytypes$Activities$Query, options: StreamMethodOptions): GaxiosPromise<Readable>;
        query(params?: Params$Resource$Organizations$Locations$Activitytypes$Activities$Query, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse>;
